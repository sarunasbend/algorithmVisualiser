 ...
 */
public class Window extends JPanel implements Runnable, KeyListener, MouseListener, MouseMotionListener
{
	// Size of playarea
	 ...
	 */
	public Window(int width, int height, boolean createWindow)
	{
	...
	private void init(int width, int height, boolean createWindow)
	{
		...
		colours.put("EDGES", new Color(42, 151, 49, 50));
		colours.put("NODES", new Color(42, 151,49));
	 ...
	 */
	public void addCircle(Circle b)
	{
